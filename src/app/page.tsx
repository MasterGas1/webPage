      ...
      <Navbar className="bg-principal-color px-3" maxWidth="full">
        ...
        <NavbarContent justify="center">
          ...
          <NavbarContent justify="start">
            <Button
              as={Link}
              className="bg-white text-principal-color font-semibold px-10"
      ...
      <div className="grid grid-cols-2 gap-4 mt-20">
        <div className="justify-end flex">
          <div className="w-1/2 justify-center flex flex-col">
            ...
            <Link
              className="bg-principal-color text-white font-semibold w-1/2 mt-20 h-12 p-4 rounded justify-center"
              href="/register-organization"
            >
              Registro
            </Link>
